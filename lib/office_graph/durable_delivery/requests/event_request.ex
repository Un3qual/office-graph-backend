defmodule OfficeGraph.DurableDelivery.EventRequest do
  @moduledoc """
  Validated request for one human-operation domain event.

  Construction and persistence normalization live here so event producers do
  not duplicate envelope validation.
  """
