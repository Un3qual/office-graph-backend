defmodule OfficeGraph.DurableDelivery.SystemEventRequest do
  @moduledoc """
  Validated request for one system-operation domain event.

  Construction and persistence normalization live here so system producers
  share the same bounded event envelope.
  """
