...
- [ ] **Step 1: Write failing receipt regressions**
...
- [ ] **Step 2: Write failing reconciliation regressions**
...
- [ ] **Step 4: Add the tagged repository wrapper and use it at integration boundaries**

Add the wrapper without changing existing bang callers:
...
- [ ] **Step 5: Run the regressions and verify GREEN**
...
- [ ] **Step 1: Write the failing operation regression**
...
- [ ] **Step 3: Replace boolean-only system authorization reads with tagged reads**
...
- [ ] **Step 4: Run the operation and webhook-worker suites**
...
- [ ] **Step 1: Clarify the OpenSpec interaction**
...
- [ ] **Step 2: Write the failing replay regression**
...
- [ ] **Step 4: Split review-reply reconciliation from creation**
...
- [ ] **Step 5: Verify both sides of the ordering invariant**
...
- [ ] **Step 2: Run the full repository gate and diff hygiene**
