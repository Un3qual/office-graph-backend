...
- **THEN** the projection read MUST use that trusted session context instead of
  re-running local owner bootstrap or accepting client-supplied session context
  maps
