# authorization-governance Specification

## Purpose
Define principal, role, capability, grant, sensitivity, authorization decision, and policy-version governance requirements.
