# operator-command-loop Specification

## Purpose

Define the supported, retry-safe operator command sequence for advancing the
manual-intake-to-verification workflow one durable step at a time.
