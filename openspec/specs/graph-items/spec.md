# graph-items Specification

## Purpose

Define the shared addressability contract, department-neutral item taxonomy,
typed-resource boundary, lifecycle posture, and provenance expectations for
Office Graph work items.
...
- **THEN** it MUST support signals, requirements, tasks, questions, decisions,
  checks, evidence, review findings, artifacts, runs, work packets,
  conversations, external references, and addressable document or plan sections
  without making software-specific concepts mandatory
