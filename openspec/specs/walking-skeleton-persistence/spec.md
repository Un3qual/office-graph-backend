...
Define the minimal persistence contract for the walking skeleton, including
the first relational schema, graph identity transactions, identity and
authorization seed records, rich-text body storage, operation/revision/audit
traceability, raw archive idempotency, and Ash ownership for stable loop
resources.
