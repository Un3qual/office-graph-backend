# run-approval-governance Specification

## Purpose
Define cross-scope agent authority, context expansion, autonomy envelopes, temporary grants, approval gates, and separation-of-duties requirements.
