# backend-app-baseline Specification

## Purpose

Define the backend application baseline for the walking skeleton: one Phoenix
API application, focused dependencies, Boundary-enforced context ownership,
Nix-shell command execution, Docker Compose Postgres for local database
workflows, and no broad runtime or frontend surface beyond the skeleton gate.
