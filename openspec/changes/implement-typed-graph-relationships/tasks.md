...
- [ ] 1.1 Add failing migration/resource tests for relationship definitions, endpoint rules, migration-installed MVP vocabulary, and absent generic registry mutations.
- [ ] 1.2 Add registry and endpoint-rule migrations plus Ash resources/domain registration, indexes, identities, and backend ownership inventory entries.
