...
- [ ] 9.2 Synchronize all delta requirements into durable specs, archive `complete-operator-command-loop`, confirm no unintended active-change or compatibility references remain, and publish the finalization PR against `main`.
