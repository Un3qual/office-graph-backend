...
### Requirement: Proposed Change Authorization
Office Graph SHALL authorize proposing, approving, and applying proposed graph
changes separately.
...
#### Scenario: Proposed change requires approval
- **WHEN** a proposed change affects sensitive data, external writes,
...
- **WHEN** a human applies or rejects a proposed change
