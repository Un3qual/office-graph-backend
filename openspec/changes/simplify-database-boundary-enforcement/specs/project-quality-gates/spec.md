...
- **WHEN** a tracked executable script contains a PostgreSQL client token
- **THEN** the source gate MUST reject the token without interpreting shell,
  JavaScript, Python, quoting, heredoc, variable, or control-flow semantics
