  ...
  defmacro __using__(_opts) do
    quote do
      ...
      defp install_raw_archive_body_wait!(body, lock_key) do
        ...
        Repo.query!(
          "DROP TRIGGER IF EXISTS office_graph_test_raw_archive_body_wait ON raw_archives"
        )
      ...
      defp wait_for_blocked_raw_archive!(_lock_key, 0),
      ...
      defp install_evidence_candidate_insert_barrier!(operation_id) do
        ...
        Repo.query!(
          "DROP FUNCTION IF EXISTS office_graph_test_evidence_candidate_insert_barrier()"
        )
      ...
      defp install_run_required_check_update_barrier!(run_id) do
        ...
        Repo.query!(
          "DROP FUNCTION IF EXISTS office_graph_test_run_required_check_update_barrier()"
        )
      ...
      defp install_verification_result_insert_barrier!(verification_check_id) do
        ...
        Repo.query!(
          "DROP FUNCTION IF EXISTS office_graph_test_verification_result_insert_barrier()"
        )
      ...
      defp install_tenancy_insert_barrier! do
        Repo.query!(
          "DROP TRIGGER IF EXISTS office_graph_test_tenancy_race_barrier ON organizations"
        )
      ...
      defp drop_owner_bootstrap_insert_barriers! do
        Repo.query!(
          "DROP TRIGGER IF EXISTS office_graph_test_identity_race_barrier ON principals"
        )

        Repo.query!("DROP FUNCTION IF EXISTS office_graph_test_identity_race_barrier()")

        Repo.query!(
          "DROP TRIGGER IF EXISTS office_graph_test_authorization_race_barrier ON roles"
        )
